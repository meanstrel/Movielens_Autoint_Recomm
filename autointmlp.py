...
# # autoIntMLP_model = AutoIntModel(field_dims, embed_dim, att_layer_num=3, att_head_num=2, att_res=True,
# #                              l2_reg_dnn=0, l2_reg_embedding=1e-5, dnn_use_bn=False
...
#         features = pred_df.iloc[i:i + batch_size, :].values.astype(np.int32) 
...
class AutoIntMLPModel(Model):
    ...
    def build(self, input_shape):
        self.autoInt_layer.build(input_shape)
